...
description: |
  Este es un libro práctico para realizar gráficas con ggplot2.
...
Juguemos con R y comencemos a editar jugando

R es un __lenguaje de programación__, muy conocido por la mayoría de los científicos.Al ser un lenguaje de programación, podemos generar instrucciones a través de códigos, según el interés del proyecto que esté realizando dicha persona. 
...
## RStudio
Es un entorno de desarrollo integrado (`IDE`, por su siglas en inglés: Integrated Development Environment) que permite utilizar lenguaje R, con interfaz interactivo para el usuario. 
...
knitr::include_graphics(rep("docs/rbase-fig-2.png"))
```
...
knitr::include_graphics(rep("docs/rstudio-fig-3.png"))
```
