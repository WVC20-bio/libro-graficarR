...
Es un paquete de múltiples funciones que actúan en la manipulación de datos. Dichas funciones se les conocen como "verbos", que pueden juntarse para obtener un resultado de interés [@peng_r_2014; @wickham2023r; @purr]. 
...
Permite crear datos ordenados, siendo las funciones principales `pivot_longer` y `pivot_wider`. La primera función transforma un dato ancho a uno largo, en cambio la otra función hace lo contrario.

## purrr

Genera bucles(`loops`) a travez de la familia de funciones llamadas __map()__.
